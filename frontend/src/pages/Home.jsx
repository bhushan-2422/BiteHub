          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-shrink-0">
                ...
                >
                  ...
                  >
                    ...
                    <path
                      d="M7 12c1.2-2.5 4.8-3 6.5-1.2 1.7 1.8 1 4.6-1.2 6"
                      stroke="#fff"
                      strokeWidth="1.2"
                      strokeLinecap="round"
              ...
              <nav className="hidden md:flex md:items-center md:space-x-6">
                ...
                <a href="#partners" className="text-sm hover:text-orange-500">
                  Partners
                </a>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight">
                  Fast, reliable food delivery — for everyone.
                </h1>
                <p className="mt-4 text-gray-700 max-w-2xl text-base sm:text-lg">
                  QuickBite connects local restaurants, delivery partners and
                  hungry customers on a single easy-to-use platform. Order in
                  minutes or manage orders for your restaurant — tailored
                  experiences for each user type.
                </p>

                <div className="mt-6 flex flex-wrap gap-3">
                  <Link
                    to="/user/register"
                    className="inline-flex items-center px-4 py-2 rounded-md shadow-sm bg-white border text-sm"
                  >
                    Order Food
                  </Link>
                  ...
                  <Link
                    to="/hotel/register"
                    className="inline-flex items-center px-4 py-2 rounded-md bg-orange-500 text-white text-sm"
                  >
                ...
                <div className="mt-8 text-sm text-gray-600">
                  <strong>Available:</strong> Web & Mobile •{" "}
                  <strong>Coverage:</strong> Your city (expandable)
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mx-auto max-w-md">
                  <div className="rounded-xl shadow-lg bg-white p-6">
                    <img
                      src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='300'><rect rx='16' width='400' height='300' fill='%23FEEBC8'/><text x='50' y='150' font-size='18' fill='%234A4A4A'>App preview placeholder</text></svg>"
                      alt="App preview"
        ...
        <section id="three-options" className="py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold text-center">
              Choose how you want to use QuickBite
            </h2>
            <p className="text-center mt-2 text-gray-600 max-w-2xl mx-auto">
              Whether you're ordering, running a kitchen, or delivering — we
              have a tailored experience for you.
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <article className="bg-white rounded-xl shadow p-6 flex flex-col">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Browse menus, place orders, track delivery in real-time
                      and save favorites.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 mt-auto">
                  <a
                    href="#user"
                    className="w-full inline-flex justify-center items-center px-4 py-2 rounded-md bg-orange-500 text-white"
                  >
                    Order Now
                  </a>
                </div>
              ...
              <article className="bg-white rounded-xl shadow p-6 flex flex-col">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Manage your menu, accept orders, view analytics and grow
                      sales.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 mt-auto">
                  <a
                    href="#owner"
                    className="w-full inline-flex justify-center items-center px-4 py-2 rounded-md border"
                  >
                    For Owners
                  </a>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="p-3 rounded-md bg-blue-100">
                    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
                      ...
                      />
                      <path
                        d="M7 20a1 1 0 100-2 1 1 0 000 2zm10 0a1 1 0 100-2 1 1 0 000 2z"
                        stroke="#2563EB"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Pick up orders, optimize routes and earn on every
                      delivery.
                    </p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Clean menu UI, saved addresses, multiple payment options and
                  quick reorders.
                </p>
              </div>
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Menu management, order dashboard, promo tools and performance
                  insights.
                </p>
              </div>
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Flexible shifts, clear payouts, and an easy-to-use partner app
        ...
        <section id="how-it-works" className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mt-2">
              Order flow simplified: choose a restaurant → place your order →
              track till delivery.
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="bg-orange-50 p-6 rounded-lg">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Pick cuisine, filter by ratings and view popular dishes.
                </p>
              </div>
              <div className="bg-orange-50 p-6 rounded-lg">
                <h5 className="font-semibold">Order</h5>
                <p className="text-sm text-gray-600 mt-2">
                  Choose delivery or pickup and checkout with secure payments.
                </p>
              </div>
              <div className="bg-orange-50 p-6 rounded-lg">
                <h5 className="font-semibold">Track</h5>
                <p className="text-sm text-gray-600 mt-2">
                  Real-time tracking, ETA, and contactless delivery options.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-10 bg-gradient-to-r from-white to-orange-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Sign up to manage orders, or place your first order in minutes.
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <a href="#learn" className="px-4 py-2 border rounded-md">
                Learn more
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-3">
                Local restaurants. Faster delivery. Happy customers.
              </p>
            </div>
